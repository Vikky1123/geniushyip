...
class FrontendController extends Controller
{
    ...
    {
        // Temporarily bypassing auth_guests to avoid the Markury class issue
        // $this->auth_guests();
    }
    ...
    public function addUserInterestBalance($data){
        ...
        if (!$user) {
            // Log the issue and skip this investment
            \Illuminate\Support\Facades\Log::warning("User not found for investment ID: {$invest->id}, user_id: {$invest->user_id}");
            return;
        }
